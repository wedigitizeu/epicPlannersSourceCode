...
<body>
	...
	<div class="page-wrapper">
				...
				<div class="row clearfix">
					...
					<div class="content-column col-lg-8 col-md-12 col-sm-12">
						<div class="inner-column">
							<h2>“What you need is an Event to remember for a lifetime.”</h2>
							<div class="bold-text">
					...
					<div class="row clearfix">
						...
						<div class="content-column col-lg-8 col-md-12 col-sm-12">
							<div class="inner-column">
								...
								<div class="bold-text">Lay your troubles on our shoulders and enjoy the event.</div>
		...
		<section class="call-to-action-section" style="background-image: url(images/background/6.jpg)">
			<div class="auto-container">
				<h2>We design events to create opportunities to create interactions.</h2>
				<div class="text"> Surprise your beloved one by collaborating with us.</div>
