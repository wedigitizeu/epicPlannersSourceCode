...
<div class="page-wrapper">
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-8 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="text">
							<p>Life is all about celebrating every little happiness and turning moments into memories. We "<?php title();?>" are here to take every responsibility of your celebration on our shoulders and let you enjoy every moment with your loved ones. You dream of your event and we'll make it happen, just like a dream come true.</p>
							<p></p>
						</div>
					</div>
				</div>
	...
	<section class="call-to-action-section" style="background-image: url(images/background/6.jpg)">
		<div class="auto-container">
			...
			<a href="contact.php" class="theme-btn btn-style-two"><span class="txt"><?php conatctPL();?></span></a>
		</div>
	</section>
