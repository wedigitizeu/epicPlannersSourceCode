...
<!-- stella-orre/index-5.html  30 Nov 2019 03:49:07 GMT -->
<head>
<meta charset="utf-8">
<title>Stella Orr'e - Interior and Home Renovation HTML Template | Home Page 05</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
            ...
            <div class="inner-container">
                <div class="auto-container clearfix">
                    ...
                    <div class="info-outer clearfix">
                        ...
                        <!--Info Box-->
                        <div class="info-box">
                            <div class="icon"><span class="flaticon-call-answer"></span></div>
                            <div class="text">
                                <strong>Need Design Consultancy</strong>
                                <a href="tel:1800-456-7890" class="number">1800 456 7890</a>
                            </div>
                        </div>
    ...
    <section class="welcome-section">
		<div class="auto-container">
			...
			<!-- Title Box -->
			<div class="title-box">
				<h2>We provide the best suggestions for Interior Designing of a given space so <br> that it can become truly a “living space”.</h2>
			</div>
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						<h2>Welcome to Stella Orr'e Best Interior Designer</h2>
						...
						<ul class="list-style-three">
							<li>5 years material warranty</li>
							<li>2500 projects has been completed</li>
							<li>500+ designers under one roof</li>
						</ul>
					</div>
				</div>
...
<!-- stella-orre/index-5.html  30 Nov 2019 03:49:28 GMT -->
</html>